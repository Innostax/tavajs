      ...
      <template #body>
          <form>
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="name-input" placeholder="Name" v-model="name" autofocus />
            </div>
          <div class="mb-3">
            <Label inputId="username-input" class="form-label" name="Username"></Label>
            <input type="text" class="form-control" id="username-input" placeholder="Username" v-model="username" />
          </div>
          <div class="mb-3">
            <Label inputId="email-input" class="form-label" name="Email"></Label>
