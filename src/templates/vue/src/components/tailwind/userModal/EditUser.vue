    ...
    <button class="ml-auto text-gray rounded px-3 py-2 text-xl  hover:text-black"  @click="close">X</button>
        ...
        <form>
          <div class="p-1 text-left">
            ...
            <input
              ...
              type="text"
              placeholder="Name"
              class="px-3 py-3 placeholder-slate-300 text-slate-600 relative h-10  rounded  border border-slate-300 outline-none focus:outline-none focus:ring w-full"
              v-model="user.name"
            >
          </div>
          <div class="p-1 text-left">
      ...
      <template v-slot:footer>
        ...
        @onClick="submitButonHandler"
         class="text-white rounded bg-blue-400 px-3 py-2  m-3 ml-auto shadow-sm hover:bg-blue-600" name="Edit User"/>
      <Button class="text-gray border border-gray-500 px-3 py-2 ml-auto  m-3 shadow-sm  hover:bg-gray-500 hover:text-white active:bg-gray-600 font-bold rounded outline-none focus:outline-none" type="button" name="Cancel" @onClick="close"/>
      </template>
    </Modal>
</template>
<script>
