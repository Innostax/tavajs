...
const VUE_APP_EXPECTED_RESULT = [
  [ '📂 Creating vue project: front-end using dev-tava 1.0.0' ],
  [ '⌛ Integrating CSS Framework: bootstrap' ], 
  [ '⌛ Integrating CSS Framework: tailwind' ],
  [ '⌛ Integrating Test Case framework: mochaJS' ],
  [ '⌛ Integrating Test Case framework: jest' ],
  [ '⌛ Integrating Test Case framework: nightwatchJS' ],
  [ '⌛ Integrating Test Case framework: cypress' ],
  [ '⌛ Integrating Theme Provider: light-dark-mode' ],
  [ '⌛ Integrating Network Informer' ],
  [ '⌛ Integrating Authentication service: Auth0' ],
  [ '⌛ Integrating Authentication service: Cognito' ],
  [ '⌛ Integrating Authentication service: Okta' ],
  [ '⌛ Integrating Vuex pattern' ],
  [ '⌛ Integrating Docker Service' ],
  [ '⌛ Integrating CI/CD Pipeline: aws' ],
  [ '⌛ Integrating CI/CD Pipeline: github' ],
  [ '📂 Creating node-js project: backend using dev-tava 1.0.0' ],
  [ '⌛ Integrating Database service: postgres'],
  [ '⌛ Integrating Database service: mysql'],
  [ '⌛ Integrating Database service: mongoose'],
  [ '⌛ Integrating Logger service: winston'],
  [ '⌛ Integrating Logger service: sentry'],
  [ '⌛ Integrating Email service: sendgrid'],
  [ '⌛ Integrating Email service: amazon_ses'],
  [ '⌛ Integrating Email service: smtp'],
  [ '⌛ Integrating Blob service: aws-s3'],
  [ '⌛ Integrating Blob service: azure'],
  [ '⌛ Integrating Docker Service' ],
  [ '© Powered by Innostax' ],
  ...
  [ '✅ Successfully created' ],
  [ '-> To get Started:' ],
  [ 'cd /home/runner/work/tavajs/tavajs\\test-cases-for-vue-tailwind' ],
  [ '-> For vue:' ],
  [ 'cd front-end' ],
  [ 'npm run serve' ],
  [ 'yarn run serve' ],
